...
fun main() {
    ...
    if (inputName != userName) println("Пользователь $userName не найден, завершите текущую сессию и зарегистрируйтесь")
    else {
        print("Введите пароль: ")
        val inputPassword = readln()

        if (inputPassword == password) println("[вздыхает...] Ваши данные проверены, и о, чудо, они верны... " +
